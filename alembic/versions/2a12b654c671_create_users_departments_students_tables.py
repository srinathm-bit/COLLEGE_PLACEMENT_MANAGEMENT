"""create users departments students tables

Revision ID: 2a12b654c671
Revises: 
Create Date: 2026-09-04 17:30:38.934007
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('ADMIN', 'PLACEMENT_OFFICER', 'STUDENT', 'COMPANY', name='userrole'), nullable=False),
